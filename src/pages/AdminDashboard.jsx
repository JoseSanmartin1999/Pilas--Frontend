                        ...
                        <div className="space-y-8 animate-in fade-in duration-300">
                            <header className="text-left space-y-1 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                ...
                                <button
                                    ...
                                    className="px-6 py-3.5 bg-[#1a3a5a] text-[#ffcc00] rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-[#112740] transition-all shadow-md hover:shadow-lg hover:scale-[1.02] flex items-center gap-2 whitespace-nowrap"
                                >
                                    📥 Descargar Reporte
                                </button>
                            </header>
                                                ...
                                                {app.academic_record_url && (
                                                    <div>
                                                        ...
                                                        <a
                                                            ...
                                                            className="inline-flex items-center gap-2 px-5 py-3 bg-blue-50 text-blue-700 border border-blue-200 rounded-xl font-bold text-xs uppercase tracking-wider hover:bg-blue-100 transition-colors"
                                                        >
